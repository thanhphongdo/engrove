...
function SpeakingHubContent() {
  ...
  // Cast to LessonMeta[] for shared search/sort utilities (SpeakingLessonMeta is structurally compatible)
  const filteredMeta = filtered as unknown as LessonMeta[];
  ...
  const display = useMemo(() => {
    const sorted =
      isSearching && sortBy === "random" ? searchedMeta : sortLessons(searchedMeta, sortBy, randomSeed);
    return sorted as unknown as SpeakingLessonMeta[];
