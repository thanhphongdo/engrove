    ...
    <div className="mt-4 space-y-5">
      ...
      {turns.map((turn, i) => {
        ...
        return (
          <div key={i}>
            {/* Role label */}
            <div className={cn("mb-1 flex items-center", isUser && "justify-end")}>
              ...
              >
                ...
                {!isUser && (
                  <button
                    ...
                    className="relative mt-0.5 shrink-0 rounded-full p-0.5 text-neutral-400 transition-colors hover:text-neutral-700 dark:hover:text-neutral-200"
                  >
                ...
                <span className="relative">
                  ...
                  {showTranslation && turn.translationVi && (
                    <span
                      className={cn(
                        "mt-1 block text-xs",
                        isUser ? "text-white/75" : "text-neutral-500 dark:text-neutral-400",
                      )}
                    >
                      {turn.translationVi}
                    </span>
                ...
                {isUser && (
                  <button
                    ...
                    onClick={() => playTurn(turn)}
                    aria-label="Play this line"
                    className="relative mt-0.5 shrink-0 rounded-full p-0.5 text-white/70 transition-colors hover:text-white"
                  >
                    <Volume2 className="size-4" aria-hidden="true" />
                  </button>
                )}
